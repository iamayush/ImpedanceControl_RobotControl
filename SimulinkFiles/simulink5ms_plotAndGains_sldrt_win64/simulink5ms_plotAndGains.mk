...
SHARED_LIB           := 
TARGET_LANG_EXT      := c
OPTIMIZATION_FLAGS   := -O4 -O4 -O4 -O4 -O4 -O4 -O4
ADDITIONAL_LDFLAGS   := 
DEFINES_CUSTOM       := 
...
# additional includes
REQ_INCLUDES += ;C:/ayush2_maa11/SimulinkFiles;C:/ayush2_maa11/SimulinkFiles/simulink5ms_plotAndGains_sldrt_win64;C:/ayush2_maa11/repo/trunk/CRSRobot/matlab;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
